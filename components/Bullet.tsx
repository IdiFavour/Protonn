        ...
        <div className="bullet my-5">
            <div className="row pt-5 me-0">
                ...
                <div className="col-lg-5 p-5 text-start">
                    ...
                    <div className="style-3 py-4">
                        <div className="tour-item ">
                            <div className="tour-desc">
                                <div className="tour-text color-grey-3">&ldquo;At this School, our mission is to balance a rigorous comprehensive college preparatory curriculum with healthy social and emotional development.&rdquo;</div>
                                ...
                                <div className="link-name ">Balbir Kaur</div>
                                <div className="link-position ">Student</div>
                            </div>
                        </div>
                    </div>
                </div>
